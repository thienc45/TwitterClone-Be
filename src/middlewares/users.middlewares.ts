        ...
        custom: {
          options: async (value: string, { req }) => {
            ...
            try {
              ...
              throw new Error(USERS_MESSAGES.INVALID_ACCESS_TOKEN)
            }
          }
        }
      }
        ...
        custom: {
          options: async (value: string, { req }) => {
            ...
            try {
              ...
              //  nếu chung với cecit thì phải check xem nó có bằng
              // decoded_refresh_token.token_type = TokenType.RefreshToken  JWT_SECRET='12344321!@#'
        ...
        custom: {
          options: async (value: string, { req }) => {
            ...
            try {
              ...
              ;(req as any).decoded_email_verify_token = decoded_email_verify_token
            } catch (error) {
              throw new ErrorWithStatus({
...
export const verifiedUserValidator = (req: Request, res: Response<any, Record<string, any>>, next: NextFunction) => {
