...
try {
  verifyEmailTemplate = fs.readFileSync(path.resolve('src/templates/verify-email.html'), 'utf8')
} catch (error) {
  console.error('Template file not found:', error)
  verifyEmailTemplate = '<p>Default email template content</p>' // Nội dung mặc định
}
